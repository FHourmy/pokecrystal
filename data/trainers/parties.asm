...
Rival1Group:
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 39, SNEASEL,    ICY_WIND, SLASH, FAINT_ATTACK, AGILITY
	db 39, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 40, OCTILLERY,  PSYBEAM, AURORA_BEAM, OCTAZOOKA, LOCK_ON
	db 40, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	...
	db 39, SNEASEL,    ICY_WIND, SLASH, FAINT_ATTACK, AGILITY
	db 39, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 40, VICTREEBEL, RAZOR_LEAF, SLUDGE, SLEEP_POWDER, STUN_SPORE
	db 40, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	...
	db 39, SNEASEL,    ICY_WIND, SLASH, FAINT_ATTACK, AGILITY
	db 39, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 40, HOUNDOOM,   TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 40, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 42, FERALIGATR, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 45, HAUNTER,    PSYCHIC_M, SHADOW_BALL, HYPNOSIS, DREAM_EATER
