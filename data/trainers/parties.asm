...
ClairGroup:
  ...
  db 44, DRAGONAIR,  THUNDER_WAVE, SURF, RAIN_DANCE, DRAGONBREATH
	db 44, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SURF, DRAGONBREATH
	db 44, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, FLAMETHROWER, DRAGONBREATH
  db 46, LAPRAS,     SURF, ICE_BEAM, BODY_SLAM, REST
