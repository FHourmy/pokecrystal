...
Rival1Group:
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 43, SNEASEL,    ICE_PUNCH, METAL_CLAW, FAINT_ATTACK, AGILITY
	db 43, GOLBAT,     SLUDGE, BITE, CONFUSE_RAY, WING_ATTACK
	db 43, GENGAR,    PSYCHIC_M, SHADOW_BALL, HYPNOSIS, DREAM_EATER
	db 44, OCTILLERY,  PSYBEAM, AURORA_BEAM, OCTAZOOKA, LOCK_ON
	db 44, HOUNDOOM,   FLAMETHROWER, IRON_TAIL, CRUNCH, DOUBLE_TEAM
	db 46, MEGANIUM,   SUNNY_DAY, GIGA_DRAIN, BODY_SLAM, SYNTHESIS
	db -1 ; end
	...
	db 43, GENGAR,    PSYCHIC_M, SHADOW_BALL, HYPNOSIS, DREAM_EATER
	db 44, OCTILLERY,  PSYBEAM, AURORA_BEAM, OCTAZOOKA, LOCK_ON
	db 44, VICTREEBEL, RAZOR_LEAF, SLUDGE_BOMB, SLEEP_POWDER, STUN_SPORE
	db 46, TYPHLOSION, FLAMETHROWER, QUICK_ATTACK, IRON_TAIL, THUNDERPUNCH
	db -1 ; end
	...
	db 44, HOUNDOOM,   FLAMETHROWER, IRON_TAIL, CRUNCH, DOUBLE_TEAM
	db 44, VICTREEBEL, RAZOR_LEAF, SLUDGE_BOMB, SLEEP_POWDER, STUN_SPORE
	db 46, FERALIGATR, ICE_PUNCH, SURF, SLASH, BITE
	db -1 ; end
