...
JasmineGroup:
	...
	db 33, MAGNETON,  THUNDER, SUPERSONIC, RAIN_DANCE, THUNDER_WAVE
	db 33, SKARMORY,  WING_ATTACK, STEEL_WING, SWAGGER, SAND_ATTACK
	db 34, SCIZOR,    METAL_CLAW, CUT, PURSUIT, AGILITY
	db 35, STEELIX,   SCREECH, SUNNY_DAY, ROCK_SLIDE, IRON_TAIL
	db -1 ; end
