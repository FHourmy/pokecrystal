...
PryceGroup:
	...
	db 37, DEWGONG,   WATERFALL, ICE_BEAM, SLEEP_TALK, REST
	db 39, JYNX,      PSYCHIC_M, ICE_PUNCH, SHADOW_BALL, ICY_WIND
	db 40, SNEASEL,   ICE_PUNCH, METAL_CLAW, FAINT_ATTACK, AGILITY
	db 42, PILOSWINE, MAGNITUDE, FURY_ATTACK, ICY_WIND, BLIZZARD
	db -1 ; end
...
ChuckGroup:
	...
	db 28, WIGGLYTUFF, DYNAMICPUNCH, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH
...
ExecutiveMGroup:
	...
	db 41, WEEZING,    ROLLOUT, SLUDGE, SMOKESCREEN, HAZE
	db 41, WEEPINBELL, SLEEP_POWDER, RAZOR_LEAF, SLUDGE_BOMB, POISONPOWDER
	db 43, HOUNDOOM,   ROAR, FLAMETHROWER, BITE, FAINT_ATTACK
	db -1 ; end
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 37, KOFFING,    ROLLOUT, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 37, GRAVELER,   ROLLOUT, SELFDESTRUCT, ROCK_SLIDE, MAGNITUDE
	db 37, ELECTRODE,  ROLLOUT, SELFDESTRUCT, SONICBOOM, THUNDERSHOCK
	db 37, FORRETRESS, ROLLOUT, SELFDESTRUCT, PIN_MISSILE, RAPID_SPIN
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 42, ARBOK,      DIG, GLARE, SLUDGE_BOMB, SCREECH
	db 42, VILEPLUME,  GIGA_DRAIN, MOONLIGHT, SLEEP_POWDER, SLUDGE
	db 44, MURKROW,    WING_ATTACK, PURSUIT, SWAGGER, NIGHT_SHADE
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 33, ARBOK,      DIG, GLARE, SLUDGE, BITE
	db 33, GLOOM,      MEGA_DRAIN, SWEET_SCENT, SLEEP_POWDER, ACID
	db 35, MURKROW,    WING_ATTACK, PURSUIT, HAZE, SWAGGER
	db -1 ; end
...
GruntFGroup:
	...
	db 27, SLOWPOKE,   WATER_GUN, CONFUSION, DISABLE, HEADBUTT
	db 31, ARBOK,      DIG, GLARE, SLUDGE, BITE
	db 31, GLOOM,      MEGA_DRAIN, ACID, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
