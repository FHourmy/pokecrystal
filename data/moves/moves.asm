...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          15, NORMAL,       100, 10,   0; acc 85->100
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, NORMAL,       100, 15,   0; acc 85->100
	...
	move CUT,          EFFECT_NORMAL_HIT,         55, BUG,          100, 30,   0; normal->bug; high crit; bp 50->55; acc 95->100
	...
	move FLY,          EFFECT_FLY,                70, FLYING,       100, 15,   0; acc 95->100
	move BIND,         EFFECT_TRAP_TARGET,        15, NORMAL,        75, 20,   0
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,        85, 20,   0; acc 75->85
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         35, GRASS,        100, 30,   0; pp 10->30
	move STOMP,        EFFECT_STOMP,              65, NORMAL,       100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,     100, 30,   0
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL,        75, 10,   0; pp 5->10
	move JUMP_KICK,    EFFECT_JUMP_KICK,          80, FIGHTING,      95, 25,   0; bp 70->80
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         60, FIGHTING,     100, 15,  30; acc 85->100
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,       100, 20,   0; acc 85->100
	move HORN_DRILL,   EFFECT_OHKO,                1, NORMAL,        30,  5,   0
	move TACKLE,       EFFECT_NORMAL_HIT,         35, NORMAL,        95, 35,   0; acc 95->100
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,       100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,        85, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL,       100, 20,   0; acc 85->100
	...
	move POISON_STING, EFFECT_POISON_HIT,         25, POISON,       100, 35,  25; bp 15->25; poison% 30->25
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   40, BUG,          100, 20,  20; bp 25->40
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          19, BUG,          100, 20,   0; bp 14->19;acc 85->100
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,        70, 20,   0; acc 55->70
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, NORMAL,       100, 20,   0; acc 90->100
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        55, 20,   0
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   45, POISON,       100, 30,  10; bp 40->45
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        120, WATER,         80, 10,   0; pp 5->10
	move SURF,         EFFECT_NORMAL_HIT,         95, WATER,        100, 15,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         95, ICE,          100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,           80, 10,  10; acc 70->80; pp 5->10
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         90, FIGHTING,     100, 25,   0; acc 80->100; bp 80->90
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, FIGHTING,     100, 20,  30; acc 90->100;
	...
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          40, GRASS,        100, 20,   0; pp 10->20 
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,         90, 10,   0
	move GROWTH,       EFFECT_SP_ATK_UP,           0, NORMAL,       100, 40,   0
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         55, GRASS,        100, 25,   0; acc 95->100;
	...
	move PETAL_DANCE,  EFFECT_RAMPAGE,            90, GRASS,        100, 20,   0; bp 70->90
	move STRING_SHOT,  EFFECT_SPEED_DOWN,          0, BUG,           95, 40,   0
	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      40, DRAGON,       100, 10,   0
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        40, FIRE,         100, 15,   0; bp 15->40; acc 70->100
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         50, ROCK,          95, 15,   0; acc 90->100
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,        100, GROUND,       100, 10,   0
	move FISSURE,      EFFECT_OHKO,                1, GROUND,        30,  5,   0
	move DIG,          EFFECT_FLY,                60, GROUND,       100, 15,   0; pp 10->15
	...
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,       100, 40,   0; acc 85->100
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,       100, 10,   0; acc 75->100
	move LICK,         EFFECT_PARALYZE_HIT,       40, GHOST,        100, 30,  30; bp 20->40
	move SMOG,         EFFECT_POISON_HIT,         20, POISON,       100, 20,  30; acc 70->100, poison% 40->30
	move SLUDGE,       EFFECT_POISON_HIT,         70, POISON,       100, 20,  30; bp 65->70
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,       100, 20,  10; acc 85->100
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,          80, 10,  10; acc 85->80; pp 8->10
	move WATERFALL,    EFFECT_SPEED_DOWN_HIT,     85, WATER,        100, 15,  20; bp 80->85, 20% speed down
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,        100, 15,   0; acc 75->100; pp 10->15
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         100, FIGHTING,      90, 20,   0; bp 85->100
	...
	move BARRAGE,      EFFECT_MULTI_HIT,          15, NORMAL,       100, 20,   0; acc 85->100
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          40, BUG,          100, 15,   0; bp 20->40
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,        75, 10,   0
	move SKY_ATTACK,   EFFECT_NORMAL_HIT,        120, FLYING,        80, 10,   0; chargeup->single turn; bp 140->120; acc 90->80; pp 5->10
	...
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        110, WATER,        100, 10,   0; bp 90->110; acc 85->100
	move EXPLOSION,    EFFECT_SELFDESTRUCT,      250, NORMAL,       100,  5,   0
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL,       100, 15,   0; acc 80->100
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,        90, 15,   0; pp 10->15
	move REST,         EFFECT_HEAL,                0, PSYCHIC_TYPE, 100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,          95, 10,  30; acc 90->95
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,       100, 15,  10; acc 90->100
	...
	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL,       100, 10,   0; acc 90->100
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        20, FIGHTING,     100, 10,   0; acc 90->100; bp 10->20
	move THIEF,        EFFECT_THIEF,              60, DARK,         100, 10, 100; bp 40->60
	move SPIDER_WEB,   EFFECT_MEAN_LOOK,           0, BUG,          100, 10,   0
	move MIND_READER,  EFFECT_LOCK_ON,             0, NORMAL,       100, 10,   0; pp 5->10
	...
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,       100, 10,   0; acc 95->100; pp 5->10
	...
	move FAINT_ATTACK, EFFECT_ALWAYS_HIT,         70, DARK,         100, 20,   0; bp 60->70
	move SWEET_KISS,   EFFECT_CONFUSE,             0, NORMAL,        75, 10,   0
	move BELLY_DRUM,   EFFECT_BELLY_DRUM,          0, NORMAL,       100, 10,   0
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         95, POISON,       100, 15,  30; bp 90->95; pp 10->15
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,       100, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT, 100, WATER,        100, 10,  50; bp 65->100; acc 85->100
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     60, ICE,          100, 15, 100; bp 55->60; acc 95->100
	move DETECT,       EFFECT_PROTECT,             0, FIGHTING,     100,  5,   0
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, GROUND,       100, 10,   0; acc 80->100
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,       100, 10,   0; pp 5->10
	move OUTRAGE,      EFFECT_RAMPAGE,           100, DRAGON,       100, 15,   0; bp 90->100
	move SANDSTORM,    EFFECT_SANDSTORM,           0, ROCK,         100, 10,   0
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          70, GRASS,        100, 15,   0; bp 60->70; pp 5->15
	...
	move SWAGGER,      EFFECT_SWAGGER,             0, NORMAL,       100, 15, 100; acc 90->100
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     70, STEEL,        100, 25,  10; acc 90->100
	move MEAN_LOOK,    EFFECT_MEAN_LOOK,           0, NORMAL,       100, 10,   0; pp 5->10
	...
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,       100, 15,   0; acc 90->100
	...
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,         100,  5,  50; acc 95->100
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       70, DRAGON,       100, 20,  30; bp 60->70
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         95, 15,  30; acc 75->95
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      70, STEEL,        100, 35,  10; bp 50->70; acc 95->100
	move VITAL_THROW,  EFFECT_ALWAYS_HIT,         70, FIGHTING,     100, 10,   0
	move MORNING_SUN,  EFFECT_MORNING_SUN,         0, NORMAL,       100, 10,   0; pp 5->10
	move SYNTHESIS,    EFFECT_SYNTHESIS,           0, GRASS,        100, 10,   0; pp 5->10
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, NORMAL,       100, 10,   0; pp 5->10
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,        1, NORMAL,       100, 15,   0
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,     100, 10,   0; acc 80->100; pp 5->10
	move TWISTER,      EFFECT_TWISTER,            50, DRAGON,       100, 20,  20; bp 40->50
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,        100, 10,   0; acc 90->100; pp 5->10
	move SUNNY_DAY,    EFFECT_SUNNY_DAY,           0, FIRE,         100, 10,   0; acc 90->100; pp 5->10
	...
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       80, NORMAL,       100, 10,   0; pp 5->10
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,         100, 10,  10; pp 5->10
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,        100, 15,  20
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  90, 15,   0; bp 80->120
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   60, FIGHTING,     100, 15,  50; bp 20->60
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,        100, 15,   0; acc 70->100
	move BEAT_UP,      EFFECT_BEAT_UP,            15, DARK,         100, 10,   0; bp 10->15
