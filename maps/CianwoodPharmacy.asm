...
CianwoodPharmacist:
	...
	clearevent EVENT_DOCTOR_PHIL_6
...
CianwoodPharmacy_MapEvents:
	...
	object_event  5,  4, SPRITE_DOCTOR, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodDoctorPhil, EVENT_DOCTOR_PHIL_5
