	...
	const BURNEDTOWER1F_HITMONCHAN
...
BurnedTower1F_MapEvents:
	...
	object_event  9,  1, SPRITE_STRONGMAN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, BurnedTower1FMatt, EVENT_STRONGMAN_MATT_2
  object_event 10,  1, SPRITE_HITMONCHAN, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, BurnedTower1FHitmonchan, EVENT_STRONGMAN_MATT_2
