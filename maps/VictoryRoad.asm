...
VictoryRoad_MapEvents:
  ...
  object_event  8, 60, SPRITE_SHINYHUNTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerShinyHunterArthurVictoryRoad, EVENT_SHINYHUNTER_ARTHUR_4
  object_event  9, 60, SPRITE_STRONGMAN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerStrongmanMattVictoryRoad, EVENT_STRONGMAN_MATT_4
  object_event 10, 60, SPRITE_DOCTOR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerDoctorPhilVictoryRoad, EVENT_DOCTOR_PHIL_7
