...
TrainerShinyHunterArthurRoute29:
...
Route29_MapEvents:
	...
	object_event 43, 14, SPRITE_SHINYHUNTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerShinyHunterArthurRoute29, EVENT_SHINYHUNTER_ARTHUR_1
