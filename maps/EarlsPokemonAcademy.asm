...
TrainerProfJulietteAcademy:
	trainer PROF, JULIETTE1, EVENT_BEAT_PROF_JULIETTE, ProfJulietteSeenText, ProfJulietteBeatenText, 0, .Script

.Script:
	endifjustbattled
	opentext
	writetext ProfJulietteBeatenText
	waitbutton
	closetext
	end

ProfJulietteSeenText:
	text "JULIETTE: I'm"
	line "going to teach"
	cont "you a lesson."
...
EarlsPokemonAcademy_MapEvents:
	...
	object_event  4,  2, SPRITE_PROF, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, TrainerProfJulietteAcademy, -1
