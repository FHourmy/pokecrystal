...
; Unused: next 48 events
	const EVENT_BLACKTHORN_CITY_CLAIR_BLOCKS_GYM

; Friends
	const EVENT_BEAT_SHINYHUNTER_ARTHUR1
	const EVENT_BEAT_SHINYHUNTER_ARTHUR4
	const EVENT_BEAT_SHINYHUNTER_ARTHUR5
	const EVENT_SHINYHUNTER_ARTHUR_1 ; until slowpoke well
	const EVENT_SHINYHUNTER_ARTHUR_2
	const EVENT_SHINYHUNTER_ARTHUR_3
	const EVENT_SHINYHUNTER_ARTHUR_4
	const EVENT_BEAT_STRONGMAN_MATT1
	const EVENT_BEAT_STRONGMAN_MATT2
	const EVENT_BEAT_STRONGMAN_MATT4
	const EVENT_BEAT_STRONGMAN_MATT5
	const EVENT_STRONGMAN_MATT_1
	...
	const EVENT_BEAT_GUIDE_HUGO_VIOLET
	const EVENT_BEAT_GUIDE_HUGO_AZALEA
	const EVENT_BEAT_GUIDE_HUGO_GOLDENROD
	const EVENT_BEAT_GUIDE_HUGO_ECRUTEAK
	const EVENT_BEAT_GUIDE_HUGO_OLIVINE
	const EVENT_BEAT_GUIDE_HUGO_CIANWOOD
	const EVENT_BEAT_GUIDE_HUGO_MAHOGANY
	const EVENT_BEAT_GUIDE_HUGO_BLACKTHORN
	const EVENT_BEAT_GUIDE_HUGO_SILVERCAVE
	const EVENT_BEAT_PROF_JULIETTE
